...
<!-- Row shape (copy, fill, repeat):
     ...
     packet.
     Lifecycle (Corpus ADR-0096): durable records (specs, ADRs, findings) are
     supersede-not-delete — mark a reversed one `superseded-by-NNNN`, keep it,
     and name an owner; transitory output (review packets, run logs) ages out to
     git history or `archive/` on a ~30-90-day window. This board is the index. -->
